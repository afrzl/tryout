...
class SoalController extends Controller
{
    ...
    public function store(Request $request, $id)
    {
        ...
        return redirect()->route('ujian.soal.index', $id)->with('message','Data berhasil disimpan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('ujian.soal.index', $soal->ujian_id)->with('message','Data berhasil disimpan');
    }
