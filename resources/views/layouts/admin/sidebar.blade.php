<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
        <img src="{{ asset('img/logo.png') }}" alt="UKM Bimbel" class="brand-image img-circle elevation-3"
            style="opacity: .8">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                @role('admin')
                    ...
                    <li class="nav-item ">
                        <a href="{{ route('admin.himada.index') }}"
                            class="nav-link {{ request()->segment(2) == 'himada' ? 'active' : '' }}">
                ...
                @role('admin')
                    <li class="nav-item">
                        <a href="{{ route('admin.paket.index') }}"
                            class="nav-link {{ request()->segment(2) == 'paket' ? 'active' : '' }}">
                ...
                @hasrole('admin')
                    <li class="nav-item">
                        <a href="{{ route('admin.voucher.index') }}"
                            class="nav-link {{ request()->segment(2) == 'voucher' ? 'active' : '' }}">
                ...
                @role('admin')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.bius.index') }}"
                            class="nav-link {{ request()->segment(2) == 'bius' ? 'active' : '' }}">
                            <i class="nav-icon fas fa-book"></i>
                            <p>
                                BIUS
                            </p>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.tonas.index') }}"
                            class="nav-link {{ request()->segment(2) == 'tonas' ? 'active' : '' }}">
                            <i class="nav-icon fas fa-book"></i>
                            <p>
                                Tonas
                            </p>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.peserta_ujian.index') }}"
                        class="nav-link {{ request()->segment(2) == 'peserta_ujian' ? 'active' : '' }}">
