<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps ps--active-y bg-white" id="sidenav-main" data-color="dark">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
            <img src="{{ asset('softUI') }}/assets/img/logo-ct-dark.png" class="navbar-brand-img h-100" alt="main_logo">
        ...
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-start p-3 w-100">
                ...
                <div class="docs-info">
                    ...
                    <a href="# target="_blank" class="btn btn-white btn-sm w-100 mb-0">Profil</a>
                </div>
            </div>
        </div>
