        ...
        <div class="row justify-content-between">
            <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                <div data-aos="zoom-out">
                    ...
                    <h2> Membantu kamu mempersiapkan seleksi masuk Polstat STIS dan sekolah kedinasan lainnya dengan maksimal dan efektif bersama mahasiswa Polstat STIS</h2>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
                    ...
                    <p>Try out UKM Bimbel merupakan sarana dalam menunjang para peserta untuk masuk sekolah kedinasan yang terdiri atas TOBAR dengan 3 gelombang dan TONAS. Selain mendapat gambaran soal, Try Out UKM Bimbel juga menawarkan Bimbingan BIUS yang tentunya membantu teman-teman untuk mematangkan persiapan seleksi masuk POLSTAT STIS dan sekolah kedinasan lain.</p>
                    ...
                    <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
                        ...
                        <p class="description">Soal akurat karena dibuat langsung oleh mahasiswa Polstat STIS yang berpengalaman mengerjakan soal asli SPMB Polstat STIS</p>
                    </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <p>
                                ...
                                Tryout SKD di TOBAR ini untuk komposisi sudah sesuai waktu ujian asli di BKN, Soal matematikanya sangat relevan dengan tahap 2 SPMB. Sehingga jadi terbiasa ngerjain soal aslinya akhirnya dapet nilai yang lumayan di tahap 2 kemarin.
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <p>
                                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                Ketika tujuanmu itu terlalu tinggi, jangan kurangi tujuanmu, tapi tingkatkan usahamu! itulah yang aku tanamkan ketika ingin masuk STIS ini. Latihan-latihan soal penting banget buatku, sampai aku menemukan TONAS ini buat menguji kemampuan ku! Beberapa soal latihannya menurutku masih fresh gitu dan mirip dengan SPMB ku saat itu. Alhamdulillah, kini aku menjadi bagian dari Polstat STIS untuk meraih impianku, mau sepertiku? tingkatkan pemahamanmu melalui TONAS ini ya!
                                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                            </p>
                        </div>
                    </div><!-- End testimonial item -->
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <p>
                                <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                                Tobar tahun 2023 keren banget, soal-soalnya semua menantang tapi masi bisa dikerjain dan lumayan yang sesuai dengan soal aslinya. semoga Tobar tahun 2024 bisa lebih keren lagi.
                                <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                            </p>
                        </div>
                    </div><!-- End testimonial item -->
    ...
    <section id="faq" class="faq section-bg">
        <div class="container">
            ...
            <div class="faq-list">
                <ul>
                    <li data-aos="fade-up">
                        <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">Apakah bimbingan dan try out yang diadakan berafiliasi dengan Polstat STIS? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                        <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                            <p>
                                Seluruh bimbingan dan try out yang diadakan tidak berafiliasi dengan Politeknik Statistika STIS. Seluruh kegiatan bimbingan dan try out sepenuhnya merupakan tanggung jawab UKM Bimbel.
                            </p>
                        </div>
                    </li>

                    <li data-aos="fade-up" data-aos-delay="100">
                        <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">Apakah soal dan pembahasan try out akan dibagi? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                    ...
                    <li data-aos="fade-up" data-aos-delay="200">
                        <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">[TOBAR] Jika sudah mendaftar batch 1, apakah harus mendaftar batch selanjutnya juga? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                        <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                Salah satu keuntungan ketika anda mendaftar TOBAR Batch 1 adalah sudah termasuk dengan Batch 2 dan Batch 3. Jadi, anda tidak perlu melakukan pendaftaran berulang pada Batch 2 dan 3. Kemudian, apabila anda mendaftar tobar Batch 2, anda tidak perlu melakukan pendaftaran pada Batch 3.
                            </p>
                        </div>
                    </li>

                    <li data-aos="fade-up" data-aos-delay="300">
                        <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">[TOBAR] Bagaimana jika saya telat mengerjakan tryout? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                        <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                Waktu pelaksanaan TOBAR adalah selama 2 hari, sehingga anda dapat mengerjakannya secara fleksibel pada rentang waktu 2 hari tersebut.
                            </p>
                        </div>
                    </li>

                    <li data-aos="fade-up" data-aos-delay="400">
                        <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">[TONAS] Jika saya berhalangan untuk mengerjakan try out pada tanggal tersebut, apakah saya dapat mengerjakannya atau mendapatkan soal dan pembahasannya? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                        <div id="faq-list-5" class="collapse" data-bs-parent=".faq-list">
                            <p>
                                Ya, bagi peserta yang berhalangan untuk melaksanakan try out di tanggal pelaksanaan, dapat mengikuti try out susulan akan tetapi nilainya tidak dimasukkan pada perankingan nasional. Peserta juga berhak untuk mendapatkan soal dan pembahasan walau tidak mengerjakan try out.
                            </p>
                        </div>
                    </li>
