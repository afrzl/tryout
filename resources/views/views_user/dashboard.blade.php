        ...
        <div class="row justify-content-between">
            <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
                <div data-aos="zoom-out">
                    <h1>Selamat Datang di Website Tryout <span>UKM BIMBEL</span></h1>
                    <h2>Membantu Kamu Mempersiapkan Seleksi Masuk Sekolah Kedinasan dengan Maksimal dan Efektif</h2>
