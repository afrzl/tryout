                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            @endif
                            <button id="kerjakan" onclick="kerjakan('{{ $ujian->id }}')" class="btn btn-success {{ (!$betweenTime) || (isset($ujian->ujianUser[0]->status) ? $ujian->ujianUser[0]->status : null) == 2 ? 'disabled' : '' }}" type="button">Kerjakan</button>
                        </div>
                    </div>
                </div>
            </div>
